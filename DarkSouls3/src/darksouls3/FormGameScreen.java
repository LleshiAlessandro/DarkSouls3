...
public class FormGameScreen extends javax.swing.JFrame {
    ...
    /**
     *
     * @param imgPath serve perché se non gli passo il percorso dell immagine
     * non posso sapere quale immagine prendere per questo form
     * @param c serve perché se non passo il character io non so le sue
     * statistiche
     * @param p serve perché il gestore di gioco richiede un player e io a me
     * serve nel FormChoiseCharacter e nel form FormOpenGame
     */
